...
public class Registration extends AppCompatActivity implements ConnectivityReceiver.ConnectivityReceiverListener, View.OnClickListener {
    ...
    private void initializeControls() {
        ...
        pg = Common.showProgressDialog(Registration.this);
    ...
    private void registration() {
        ...
        if (!isConnected) {
            AlertDialog.Builder builder =
                    new AlertDialog.Builder(Registration.this, R.style.AlertDialogTheme);
